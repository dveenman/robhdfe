...
The program comes with a `julia` option, which can significantly speed up the estimation process for very large datasets. This option requires a [Julia installation](https://github.com/JuliaLang/juliaup) and the following packages to be installed (and fully working) in Stata:
```
